export default () => 
   <svg version="1.1"
   id="Layer_1" 
   xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 414 422.2" fill="var(--red)"
   dangerouslySetInnerHTML={{__html:`<style type="text/css">
   .st0 {
      var(--red);
   }
   </style>
   <path id="hammer_head" className="st0" d="M131.7,81.5l-93.3,88.8l49.7,49.7l43-43.2c83.8,85,148.9,151.1,229.8,233.2
